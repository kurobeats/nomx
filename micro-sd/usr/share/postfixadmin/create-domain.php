...
$form_fields = array(
    ...
    'fGdUser'         => array('type' => 'str', 'default' => ''),
    'fGdPass'         => array('type' => 'str', 'default' => ''),
...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    if ($error != 1)
    {
        ...
        $sql_query = "INSERT INTO $table_domain (domain,description,aliases,mailboxes,maxquota,transport,backupmx,gduser,gdpass,created,modified) VALUES ('$fDomain','$fDescription',$fAliases,$fMailboxes,$fMaxquota,'$fTransport','$sqlBackupmx','$fGdUser','$fGdPass',NOW(),NOW())";
