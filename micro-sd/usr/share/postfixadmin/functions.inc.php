...
// get_handshake
//shawn
function get_handshake ($handshake)
{
	global $CONF;
	$list = array ();
        $result = db_query("Select destination, description from handshake where domain='$handshake'");
   if ($result['rows'] > 0)
   {
...
function get_domain_properties ($domain)
{
    ...
    $list['gduser'] = $row['gduser'];
    $list['gdpass'] = $row['gdpass'];
